...
const SignIn = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Sign In | Express Cargo</title>
            </Helmet>
                    ...
                    <div className="w-full lg:w-[500px]">
                        <form onSubmit={handleLogin} className="md:card-body">
                            ...
                            <div className="form-control mt-2">
                                <button disabled={disable} className={disable ? 'btn' : "btn bg-gradient-to-r from-[#F5793B] to-[#db7f1c] hover:from-[#db7f1c] hover:to-[#F5793B] text-white"}>Sign Up</button>
                            </div>
                        </form>
